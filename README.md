...
2. **⋮ → Repositories**
3. Add this repo:
   - `https://github.com/WeLizard/OpenClawHomeAssistant`
4. Install **OpenClaw Assistant**

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=WeLizard/OpenClawHomeAssistant&type=date&legend=top-left)](https://www.star-history.com/#WeLizard/OpenClawHomeAssistant&type=date&legend=top-left)
